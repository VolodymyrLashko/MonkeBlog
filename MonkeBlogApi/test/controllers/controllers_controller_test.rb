...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { Category: @controller.Category } }, as: :json
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { Category: @controller.Category } }, as: :json
    assert_response 200
  end
